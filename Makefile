#############################################################################
# Makefile for building: Batcoin-Qt.app/Contents/MacOS/Batcoin-Qt
# Generated by qmake (2.01a) (Qt 4.8.5) on: Sun Jan 5 20:48:53 2014
# Project:  batcoin-qt.pro
# Template: app
# Command: /opt/local/bin/qmake -config release -o Makefile batcoin-qt.pro
#############################################################################
...
CFLAGS        = -pipe -O2 -arch i386 -pthread -Wall -W $(DEFINES)
CXXFLAGS      = -pipe -fstack-protector-all -D_FORTIFY_SOURCE=2 -O2 -arch i386 -pthread -fdiagnostics-show-option -Wall -Wextra -Wformat -Wformat-security -Wno-unused-parameter -Wstack-protector $(DEFINES)
INCPATH       = -I/opt/local/share/qt4/mkspecs/macx-g++ -Ibuild -I/opt/local/Library/Frameworks/QtCore.framework/Versions/4/Headers -I/opt/local/Library/Frameworks/QtNetwork.framework/Versions/4/Headers -I/opt/local/Library/Frameworks/QtGui.framework/Versions/4/Headers -Isrc -Isrc/json -Isrc/qt -I/opt/local/include/db48 -I/opt/local/Library/Frameworks/QtGui.framework/Versions/4/Headers -I/opt/local/Library/Frameworks/QtNetwork.framework/Versions/4/Headers -I/opt/local/Library/Frameworks/QtCore.framework/Versions/4/Headers -I/opt/local/include -Ibuild
LINK          = /usr/bin/clang++
LFLAGS        = -headerpad_max_install_names -fstack-protector-all -arch i386 -all_load -pthread -undefined dynamic_lookup -rdynamic
LIBS          = $(SUBLIBS)   -lminiupnpc -framework Foundation -framework ApplicationServices -framework AppKit -framework CoreServices -L/opt/local/lib -L/opt/local/lib/db48 -lssl -lcrypto -ldb_cxx-4.8 -lboost_system-mt -lboost_filesystem-mt -lboost_program_options-mt -lboost_thread-mt -lboost_chrono-mt -framework QtGui -F/opt/local/Library/Frameworks -framework QtCore -framework QtNetwork 
AR            = ar cq
RANLIB        = ranlib -s
...
DIST          = /opt/local/share/qt4/mkspecs/common/unix.conf \
		...
		batcoin-qt.pro
QMAKE_TARGET  = Batcoin-Qt
DESTDIR       = 
TARGET        = Batcoin-Qt.app/Contents/MacOS/Batcoin-Qt
...
all: Makefile Batcoin-Qt.app/Contents/PkgInfo Batcoin-Qt.app/Contents/Resources/empty.lproj Batcoin-Qt.app/Contents/Info.plist Batcoin-Qt.app/Contents/Resources/bitcoin.icns $(TARGET)

$(TARGET): /Users/donatekikorose/Desktop/BatCoin2/build/build.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_miningpage.h build/ui_optionsdialog.h $(OBJECTS)  
	@$(CHK_DIR_EXISTS) Batcoin-Qt.app/Contents/MacOS/ || $(MKDIR) Batcoin-Qt.app/Contents/MacOS/ 
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: batcoin-qt.pro  /opt/local/share/qt4/mkspecs/macx-g++/qmake.conf /opt/local/share/qt4/mkspecs/common/unix.conf \
		/opt/local/share/qt4/mkspecs/common/mac.conf \
		/opt/local/share/qt4/mkspecs/common/gcc-base.conf \
		/opt/local/share/qt4/mkspecs/common/gcc-base-macx.conf \
		/opt/local/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -config release -o Makefile batcoin-qt.pro
...
Batcoin-Qt.app/Contents/PkgInfo: 
	@$(CHK_DIR_EXISTS) Batcoin-Qt.app/Contents || $(MKDIR) Batcoin-Qt.app/Contents 
	@$(DEL_FILE) Batcoin-Qt.app/Contents/PkgInfo
	@echo "APPL????" >Batcoin-Qt.app/Contents/PkgInfo
Batcoin-Qt.app/Contents/Resources/empty.lproj: 
	@$(CHK_DIR_EXISTS) Batcoin-Qt.app/Contents/Resources || $(MKDIR) Batcoin-Qt.app/Contents/Resources 
	@touch Batcoin-Qt.app/Contents/Resources/empty.lproj
	
Batcoin-Qt.app/Contents/Info.plist: 
	@$(CHK_DIR_EXISTS) Batcoin-Qt.app/Contents || $(MKDIR) Batcoin-Qt.app/Contents 
	@$(DEL_FILE) Batcoin-Qt.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@ICON@,bitcoin.icns,g" -e "s,@EXECUTABLE@,Batcoin-Qt,g" -e "s,@TYPEINFO@,????,g" /opt/local/share/qt4/mkspecs/macx-g++/Info.plist.app >Batcoin-Qt.app/Contents/Info.plist
Batcoin-Qt.app/Contents/Resources/bitcoin.icns: src/qt/res/icons/bitcoin.icns
	@$(CHK_DIR_EXISTS) Batcoin-Qt.app/Contents/Resources/ || $(MKDIR) Batcoin-Qt.app/Contents/Resources/ 
	@$(DEL_FILE) Batcoin-Qt.app/Contents/Resources/bitcoin.icns
	@$(COPY_FILE) src/qt/res/icons/bitcoin.icns Batcoin-Qt.app/Contents/Resources/bitcoin.icns
dist: 
	@$(CHK_DIR_EXISTS) build/Batcoin-Qt1.0.1.9 || $(MKDIR) build/Batcoin-Qt1.0.1.9 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Batcoin-Qt1.0.1.9/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/Batcoin-Qt1.0.1.9/ && $(COPY_FILE) --parents src/qt/macdockiconhandler.mm src/qt/macnotificationhandler.mm build/Batcoin-Qt1.0.1.9/ && $(COPY_FILE) --parents src/qt/bitcoingui.h src/qt/transactiontablemodel.h src/qt/addresstablemodel.h src/qt/optionsdialog.h src/qt/sendcoinsdialog.h src/qt/addressbookpage.h src/qt/signverifymessagedialog.h src/qt/aboutdialog.h src/qt/editaddressdialog.h src/qt/bitcoinaddressvalidator.h src/addrman.h src/base58.h src/bignum.h src/checkpoints.h src/compat.h src/sync.h src/util.h src/uint256.h src/serialize.h src/strlcpy.h src/main.h src/net.h src/key.h src/db.h src/walletdb.h src/script.h src/init.h src/irc.h src/mruset.h src/json/json_spirit_writer_template.h src/json/json_spirit_writer.h src/json/json_spirit_value.h src/json/json_spirit_utils.h src/json/json_spirit_stream_reader.h src/json/json_spirit_reader_template.h src/json/json_spirit_reader.h src/json/json_spirit_error_position.h src/json/json_spirit.h src/qt/clientmodel.h src/qt/guiutil.h src/qt/transactionrecord.h src/qt/guiconstants.h src/qt/optionsmodel.h src/qt/monitoreddatamapper.h src/qt/transactiondesc.h src/qt/transactiondescdialog.h src/qt/bitcoinamountfield.h src/wallet.h src/keystore.h src/qt/transactionfilterproxy.h src/qt/transactionview.h src/qt/walletmodel.h src/bitcoinrpc.h src/qt/overviewpage.h src/qt/csvmodelwriter.h src/crypter.h src/qt/sendcoinsentry.h src/qt/qvalidatedlineedit.h src/qt/bitcoinunits.h src/qt/qvaluecombobox.h src/qt/askpassphrasedialog.h src/protocol.h src/qt/notificator.h src/qt/qtipcserver.h src/allocators.h src/ui_interface.h src/scrypt.h src/qt/miningpage.h src/version.h src/qt/rpcconsole.h src/qt/macdockiconhandler.h src/qt/macnotificationhandler.h build/Batcoin-Qt1.0.1.9/ && $(COPY_FILE) --parents src/qt/bitcoin.qrc build/Batcoin-Qt1.0.1.9/ && $(COPY_FILE) --parents src/qt/bitcoin.cpp src/qt/bitcoingui.cpp src/qt/transactiontablemodel.cpp src/qt/addresstablemodel.cpp src/qt/optionsdialog.cpp src/qt/sendcoinsdialog.cpp src/qt/addressbookpage.cpp src/qt/signverifymessagedialog.cpp src/qt/aboutdialog.cpp src/qt/editaddressdialog.cpp src/qt/bitcoinaddressvalidator.cpp src/version.cpp src/sync.cpp src/util.cpp src/netbase.cpp src/key.cpp src/script.cpp src/main.cpp src/init.cpp src/net.cpp src/irc.cpp src/checkpoints.cpp src/addrman.cpp src/db.cpp src/walletdb.cpp src/json/json_spirit_writer.cpp src/json/json_spirit_value.cpp src/json/json_spirit_reader.cpp src/qt/clientmodel.cpp src/qt/guiutil.cpp src/qt/transactionrecord.cpp src/qt/optionsmodel.cpp src/qt/monitoreddatamapper.cpp src/qt/transactiondesc.cpp src/qt/transactiondescdialog.cpp src/qt/bitcoinstrings.cpp src/qt/bitcoinamountfield.cpp src/wallet.cpp src/keystore.cpp src/qt/transactionfilterproxy.cpp src/qt/transactionview.cpp src/qt/walletmodel.cpp src/bitcoinrpc.cpp src/rpcdump.cpp src/rpcnet.cpp src/rpcrawtransaction.cpp src/qt/overviewpage.cpp src/qt/csvmodelwriter.cpp src/crypter.cpp src/qt/sendcoinsentry.cpp src/qt/qvalidatedlineedit.cpp src/qt/bitcoinunits.cpp src/qt/qvaluecombobox.cpp src/qt/askpassphrasedialog.cpp src/protocol.cpp src/qt/notificator.cpp src/qt/qtipcserver.cpp src/qt/rpcconsole.cpp src/scrypt.c src/qt/miningpage.cpp src/noui.cpp build/Batcoin-Qt1.0.1.9/ && $(COPY_FILE) --parents src/qt/macdockiconhandler.mm src/qt/macnotificationhandler.mm build/Batcoin-Qt1.0.1.9/ && $(COPY_FILE) --parents src/qt/forms/sendcoinsdialog.ui src/qt/forms/addressbookpage.ui src/qt/forms/signverifymessagedialog.ui src/qt/forms/aboutdialog.ui src/qt/forms/editaddressdialog.ui src/qt/forms/transactiondescdialog.ui src/qt/forms/overviewpage.ui src/qt/forms/sendcoinsentry.ui src/qt/forms/askpassphrasedialog.ui src/qt/forms/rpcconsole.ui src/qt/forms/miningpage.ui src/qt/forms/optionsdialog.ui build/Batcoin-Qt1.0.1.9/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/Batcoin-Qt1.0.1.9/ && (cd `dirname build/Batcoin-Qt1.0.1.9` && $(TAR) Batcoin-Qt1.0.1.9.tar Batcoin-Qt1.0.1.9 && $(COMPRESS) Batcoin-Qt1.0.1.9.tar) && $(MOVE) `dirname build/Batcoin-Qt1.0.1.9`/Batcoin-Qt1.0.1.9.tar.gz . && $(DEL_FILE) -r build/Batcoin-Qt1.0.1.9
...
distclean: clean
	-$(DEL_FILE) -r Batcoin-Qt.app
	-$(DEL_FILE) Makefile


/Users/donatekikorose/Desktop/BatCoin2/build/build.h: FORCE
	cd /Users/donatekikorose/Desktop/BatCoin2; /bin/sh share/genbuild.sh /Users/donatekikorose/Desktop/BatCoin2/build/build.h
