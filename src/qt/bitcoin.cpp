...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occured. BatCoin can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
// TODO: implement URI support on the Mac.
    ...
    {
        if (boost::algorithm::istarts_with(argv[i], "BatCoin:"))
        {
    ...
    app.setOrganizationDomain("BatCoin-noexist-domain.org");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        app.setApplicationName("BatCoin-Qt-testnet");
    else
        app.setApplicationName("BatCoin-Qt");
