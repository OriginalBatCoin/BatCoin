    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a BatCoin address"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a BatCoin address"));
    ui->signatureIn_VM->setPlaceholderText(tr("Enter BatCoin signature"));
#endif
